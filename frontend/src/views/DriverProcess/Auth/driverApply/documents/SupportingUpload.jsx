...
const SupportingUpload = ({ setFormdata, setIsShow }) => {
  const handleDriverSupportingFile = (e) => {
      ...
      <div className="w-full max-w-2xl bg-white shadow-sm">
        ...
        <main className="p-6">
          <h1 className="text-2xl font-bold mb-6">
            Take a photo of your suppporting files
          </h1>
          ...
          <input
            type="file"
            id="licenseFile"
            onChange={handleDriverSupportingFile}
            hidden
          />
