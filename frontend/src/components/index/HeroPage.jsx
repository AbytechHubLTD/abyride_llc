...
import image6 from "../../assets/images/hero/trans2.avif";
...
const HeroPage = () => {
  ...
  return (
    ...
    <div className="w-full  gap-4 flex-col xl:h-[84vh]  xl:flex-row justify-between items-center flex">
      {/* Slideshow container */}
      <motion.div
        className="xl:w-9/12 h-[78vh] lg:h-[84vh]  w-full flex flex-col gap-4 justify-center p-7 sm:p-10 md:p-20 lg:p-30 xl:p-40 items-start text-white rounded-xl"
        style={{
      ...
      {/*side bar  which contain two cards  */}
      <SideBar />
    </div>
