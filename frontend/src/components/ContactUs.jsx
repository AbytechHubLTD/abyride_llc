...
import ContactBgImg from "../assets/images/contact-bg.jpg"; // Import the image
import BgBannerContactImg from "../assets/images/bg-contact-banner.png"; // Import the image
    ...
    <div className="gpp-container">
      <div className="gpp-top-header">
        <div className="l-top-header">
          <div>
            <i class="fa-solid fa-location-pin pr-1"></i> 423B, Road WorldWide
            Country, USA
          </div>
          <div>
            <i class="fa-regular fa-envelope pr-1"></i> abyridellc@gmail.com
          </div>
        </div>
        <div className="r-top-header">
          <div>
            <i class="fa-solid fa-phone pr-1"></i> | + (250) 792 054 846
          </div>
          <div className="gppIcons">
            <a href="#instagram">
              <i class="fa-brands fa-instagram gpp-icon"></i>
            </a>
            <a href="#twitter">
              <i class="fa-brands fa-twitter gpp-icon"></i>
            </a>
            <a href="#whatsapp">
              <i class="fa-brands fa-whatsapp gpp-icon"></i>
            </a>
            <a href="#facebook">
              <i class="fa-brands fa-facebook gpp-icon"></i>
            </a>
          </div>
        </div>
      </div>
